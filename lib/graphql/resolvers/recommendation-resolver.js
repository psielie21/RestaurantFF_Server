                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 2:
                            ...
                            _context.next = 7;
                            return _Restaurant2.default.create({ api_id: restaurant, name: restName, location: { type: "Point", coordinates: [longitude, latitude] } });
                        ...
                        case 11:
                            ...
                            _context.next = 15;
                            return _Recommendation2.default.create({ body: body, rating: rating, author: user._id, restaurant: restaurant, location: { type: "Point", coordinates: [found.location.coordinates[0], found.location.coordinates[1]] } });
